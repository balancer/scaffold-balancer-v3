 ...
 */
export const useJoin = (pool: `0x${string}`): JoinPoolFunctions => {
  ...
  /**
   * @param amountsIn the amounts of tokens used to join the pool
   * @returns An object containing the expected and minimum BPT out amount.
   */
  const queryJoin = async (amountsIn: InputAmount[]): QueryJoinResponse => {
    try {
