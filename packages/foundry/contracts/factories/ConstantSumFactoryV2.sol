...
import { ConstantSumPoolV2 } from "../pools/ConstantSumPoolV2.sol";
 ...
 */
contract ConstantSumFactoryV2 is BasePoolFactory {
    /**
    ...
    ) BasePoolFactory(vault, pauseWindowDuration, type(ConstantSumPoolV2).creationCode) {}
