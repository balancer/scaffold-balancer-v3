...
import { ExponentialProductPool } from "./ExponentialProductPool.sol";
 ...
 */
contract ExponentialProductFactory is BasePoolFactory {
    /**
    ...
    ) BasePoolFactory(vault, pauseWindowDuration, type(ExponentialProductPool).creationCode) {}
