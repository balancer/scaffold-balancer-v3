 ...
 */
contract DeployConstantProductPoolV2 is PoolHelpers, ScaffoldHelpers {
    function deployConstantProductPoolV2(address token1, address token2) internal {
        // Set the deployment configurations
        CustomPoolConfig memory poolConfig = getProductPoolConfigV2(token1, token2);
        InitializationConfig memory initConfig = getProductPoolInitConfigV2(token1, token2);
        ...
        // Deploy a factory
        ConstantProductFactoryV2 factory = new ConstantProductFactoryV2(vault, 365 days); //pauseWindowDuration
     ...
     */
    function getProductPoolConfigV2(
        address token1,
        address token2
     ...
     */
    function getProductPoolInitConfigV2(
        address token1,
        address token2
