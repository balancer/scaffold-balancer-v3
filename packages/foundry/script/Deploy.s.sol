...
import { DeployConstantProductLoyaltyPool } from "./04_DeployConstantProductLoyaltyPool.s.sol";
...
contract DeployScript is
    ...
    DeployConstantProductLoyaltyPool
{
    function run() external scaffoldExport {
        // Deploy mock tokens to use for the pools and hooks
        (address mockToken1, address mockToken2, address mockVeBAL, address loyaltyToken) = deployMockTokens();
        ...
        // Deploy, register, and initialize a constant product pool with Loyalty hook
        deployConstantProductLoyaltyPool(mockToken1, mockToken2, loyaltyToken);
    }
