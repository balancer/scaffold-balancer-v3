...
import { DeploySerenePool } from "./04_DeploySerenePool.s.sol";
    ...
    DeploySerenePool
{
    function run() external scaffoldExport {
        ...
        // Deploy, register, and initialize a weighted pool with an serene hook
        deploySerenePool(mockToken1, mockToken2);
    }
