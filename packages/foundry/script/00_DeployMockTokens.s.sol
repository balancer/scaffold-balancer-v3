...
contract DeployMockTokens is ScaffoldHelpers {
    function deployMockTokens() internal returns (address mockToken1, address mockToken2, address mockVeBAL, address mockStable) {
        ...
        mockStable = address(new MockStable("Mock Stable Token", "MST", 1000e18));
        console.log("MockToken1 deployed at: %s", mockToken1);
        console.log("MockToken2 deployed at: %s", mockToken2);
        console.log("MockStable deployed at: %s", mockStable);
