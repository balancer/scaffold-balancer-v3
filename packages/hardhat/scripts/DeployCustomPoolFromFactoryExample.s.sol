    ...
    HelperFunctions
{
    ...
    CustomPoolFactoryExample customPoolFactory =
        CustomPoolFactoryExample(0x95fE678F71DEC07Ed20F31D3b70656e5f31d4Dca); // TODO - assign the customPoolFactory address. By default, with this repo & README, you can get the example customPoolFactory address by running the `DeployCustomPoolFactoryAndNewPoolExample.s.sol` script and reading the logs.
    ...
    function run() external {
        ...
        string memory name = "Example Custom Balancer Constant Price Pool #7"; // TODO - Make sure to change the name to avoid collisions, this will occur if you run this script more than once without changing the name here.
        ...
        console.log("New Pool Address: %s", address(newPool)); // new pool address to search on "Pools" page of front end
